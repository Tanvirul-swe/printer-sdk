...
public class PrintUtils {
	...
	public static void printCustomImage(Resources resources,
			PrinterInstance mPrinter, boolean isStylus, boolean is58mm) throws IOException {
		mPrinter.init();
		...
		fp.setFont(false, false, false, false, 25, null);
		cp.setFontProperty(fp);
		cp.drawText("অঙ্কুর কৃষি প্রেসক্রিপশন");
		fp.setSize(50);
		cp.drawText("প্রস্তুতকারক");
		cp.setTextSize(30);
		cp.drawText("আইপেজ");


//		cp.drawText(" Paragraph এর Topic idea এর সঙ্গে যেন পরবর্তী অংশ সঙ্গতিপূর্ণ হয় এমনভাবেই বক্তব্য উপস্থাপন করা জরুরী। Main idea এর সঙ্গে প্রাসঙ্গিক নয় এমন বক্তব্য বা আলোচনা সম্বলিত বাক্য (Destroyer) ব্যবহার করা হলে প্যারাগ্রাফের ঐক্যভাব নষ্ট হয়ে যেতে পারে। ফলে অপ্রাসঙ্গিক বক্তব্য উপস্থাপনায় না নিয়ে আসাই শ্রেয়");
//		cp.drawImage(BitmapFactory.decodeResource(resources,
//				R.drawable.rsz_prescription));
//		cp.drawImage(bitmap);
